...
class FontsControllerTest < ActionController::TestCase
  ...
  test "should create font" do
    assert_difference('Font.count') do
      post :create, font: { css: @font.css, description: @font.description, fontnames: @font.fontnames, html: @font.html }
    end
  ...
  test "should update font" do
    patch :update, id: @font, font: { css: @font.css, description: @font.description, fontnames: @font.fontnames, html: @font.html }
    assert_redirected_to font_path(assigns(:font))
  end
